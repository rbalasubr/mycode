...
# Define our "base" API
API = "https://api.magicthegathering.io/v1/types" # this will never change regardless of the lookup we perform
...
def main():
    ...
    resp = requests.get(f"{API}")   # this "f" string reads: API + "cards/" + setcode
    ...
    #print(cards)
    #wfh = open('cardfile.json', 'w')
    #json.dump(cards, wfh, indent=4)
    #wfh.close()
