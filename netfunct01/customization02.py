...
def devicereboot(devicelist): # devicecmd==list

    for ip in devicelist: # looping through the list
        print(f'connecting to {ip}') # fstring
        print(f'REBOOTING NOW!') # fstring
        # we'll learn to write code that connects to devices here
    return None
...
def main():
    ...
    devicelist = ['10.1.0.1', '10.2.0.1', '10.3.0.1']
    ...
    devicereboot(devicelist) # call function to do device reboot
